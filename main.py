...
def get_countries(df_document):
    return df_document.visitor_country.value_counts().rename_axis('visitor_country').to_frame('number_visitors')
...
def get_browsers(df_global):
    ...
    return df_global.visitor_useragent.value_counts().rename_axis('visitor_browser').to_frame('number_visitors')
